...
root_search_path = "/media/hireslab/AHHD_001/Data/AH0030/141114";
...
def process_mp4_file(mypath, myfile, mydir):
  ...
  # 777 permission ; this will have to occur a few times more
	...
	for f in range(0,nframes[0]):
		offs = 8192+(f*truesize[0]); #Changed header size from 1024 due to chagne in streampix -JS 2014-11-07 17:52:38 
