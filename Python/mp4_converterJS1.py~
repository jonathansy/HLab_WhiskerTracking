...
root_search_path = "/home/jonathan/Documents/HiresLab/WhiskerTracking";

# settings that may change per-user?
if (1 == 1): # production
	ffmpeg_path = "/home/jonathan/Documents/HiresLab/Code/ffmpeg-2.4.2/ffmpeg";
...
def process_mp4_file(mypath, myfile, mydir):
  ...
  # 777 permission ; this will have to occur a few times more
	...
	tmp_dir = "/home/jonathan/Documents/HiresLab/scratch/" + myfile.replace(".seq", "_tmp");
	script += "try:\n";
